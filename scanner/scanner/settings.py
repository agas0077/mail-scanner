...
SECRET_KEY = (
    "django-insecure-jtr_#&s)#2o2rzu*!6cydy8-^mn@_-h=q4)a^#j^uodb$jlf$9"
)
...
INSTALLED_APPS = [
    ...
    "django_tables2",
    "bootstrap3",
    "mailscanner.apps.MailscannerConfig",
]
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "mailscanner", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "mailscanner", "static"),
]
